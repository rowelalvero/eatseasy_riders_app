...
class EatsEasyWalletScreen extends StatefulWidget {
  const EatsEasyWalletScreen({Key? key}) : super(key: key);

  @override
  _EatsEasyWalletScreenState createState() => _EatsEasyWalletScreenState();
}

class _EatsEasyWalletScreenState extends State<EatsEasyWalletScreen> {
  @override
